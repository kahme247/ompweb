...
import { closeSync, existsSync, mkdirSync, mkdtempSync, openSync, readFileSync, rmSync, truncateSync, writeFileSync } from "node:fs";
...
function makeOversized(filePath) {
  ...
  truncateSync(fd, MAX_SESSION_LOAD_BYTES + 1);
  closeSync(fd);
}
